...
train_set, test_set = train_test_split(final_df, test_size=0.25, random_state=42)
...
for fold, (train_idx, val_idx) in enumerate(kf.split(train_set)):
    ...
    train_data_fold = KmClass(train_df, p2rank_dir)

    amino_scaler = train_data_fold.amino_scaler
    descriptor_scaler_robust = train_data_fold.descriptor_scaler_robust
    descriptor_scaler_minmax = train_data_fold.descriptor_scaler_minmax
    km_scaler = train_data_fold.km_scaler

    val_data_fold = KmClass(val_df, p2rank_dir, amino_scaler, descriptor_scaler_robust, descriptor_scaler_minmax, km_scaler)
    
    # Create DataLoaders
    train_loader = DataLoader(train_data_fold, batch_size=32, shuffle=True, collate_fn=collate_fn, num_workers=16)
    val_loader = DataLoader(val_data_fold, batch_size=32, shuffle=False, collate_fn=collate_fn, num_workers=16)
    test_loader = DataLoader(test_data, batch_size=len(test_set), shuffle=True, collate_fn=collate_fn, num_workers=16)
...
plt.legend()
plt.grid()
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/foldwise_loss_{version}.png")
plt.close()
...
plt.legend()
plt.grid()
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/foldwise_r2_{version}.png")
plt.close()
...
plt.legend()
plt.grid()
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/foldwise_pearson_{version}.png")
plt.close()
...
plt.bar(x, averages, yerr=std_devs, capsize=5, color=["blue", "red", "blue", "red", "blue", "red"])
...
plt.grid(axis='y')
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/summarized_metrics_{version}.png")
plt.close()
...
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/residual_analysis_plot_{version}.png")
plt.close()
...
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/predicted_vs_true_plot_{version}.png")
plt.close()
...
plt.ylim(bottom=0)
plt.legend()
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/loss_over_epoch_{version}.png")
plt.close()
...
plt.ylim(top=1)
plt.legend()
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/r2_over_epoch_{version}.png")
plt.close()
...
plt.ylim(top=1)
plt.legend()
plt.savefig(f"/work/sandner/Thesis/Thesis/Final_data/Graphs/model_output/{folder}/pearson_over_epoch_{version}.png")
plt.close()
...
log_file = "/work/sandner/Thesis/Thesis/Final_data/tracking/experiments_log.tsv"
